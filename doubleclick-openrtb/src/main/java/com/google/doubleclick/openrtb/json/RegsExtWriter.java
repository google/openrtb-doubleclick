...
/**
 * Writer for {@link RegsExt}.
 */
class RegsExtWriter extends OpenRtbJsonExtWriter<RegsExt> {

  @Override protected void write(RegsExt ext, JsonGenerator gen) throws IOException {
    if (ext.hasGdpr()) {
      writeIntBoolField("gdpr", ext.getGdpr(), gen);
    }
  }
}
